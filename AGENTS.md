...
5. for README or other human-facing work, read `docs/README_PLAYBOOK.md`, `docs/IMAGE_GUIDE.md`, and `templates/readme-contract.json`;
6. inspect prior reviewed outputs in the target repository before inventing a new story or visual direction;
